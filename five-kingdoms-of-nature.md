...
**Summary**: Source-specific notes on the five-kingdom framework used in *Compendium of Zoology*.
...
The source says that living organisms can be organized into five kingdoms: Monera, Protista, Fungi, Plantae, and Animalia. It presents this model as an expansion of the older Linnaean plant-animal split, which the book says became inadequate once microorganisms and fungi had to be classified more carefully. (source: Zoology.pdf - Pages 13-14)

## Why the source uses this model

The book argues that the discovery of microscopic life made it difficult to force all organisms into only plants or animals. Unicellular eukaryotes, prokaryotes, and fungi each showed combinations of traits that did not fit neatly into the older two-kingdom picture, so the five-kingdom model is introduced as a practical solution. (source: Zoology.pdf - Pages 13-14)
...
This page should be read as a summary of the source's framework rather than a statement of current consensus taxonomy. The source explicitly uses the older five-kingdom language of Monera and Protista, and later pages preserve that vocabulary when summarizing what the book says. (source: Zoology.pdf - Pages 13-14)
